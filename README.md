...
center отрисовывает время по всему блоку.
...
dividerDisplay убирает или отображает разделители (типа двоиточия)
...
timeSecondsFlag показывает секунды в другом формате
...
x и y смещает отрисовку графического времени по координатам x и y
* x : 150 - смещение по x
* y : 10 - смещение по y
